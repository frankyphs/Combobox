...
// export const SingleTag = (props:IFieldDropdown) => {
...
//     if (props.value) {
//       const filterOption = (props.value as string[]).filter((o:any) => o !== option);
//       props.onChange?props.onChange(filterOption):null;
//     }
